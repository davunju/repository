...
const NewsArticle = () => {
  ...
  return (
    <main className="text-slate-700 w-full max-w-6xl px-5 md:p-0 mx-auto mb-10 md:mb-16">
      <div className="w-full md:w-10/12 mx-auto">
        <div>
          {" "}
          {article && (
            <>
              <div className="flex gap-2 items-center mb-4 font-medium">
                <svg
              ...
              <h1 className="mb-4 font-semibold md:text-3xl text-2xl w-[90%] leading-10">
                {article.title}
              </h1>

              <div className="flex gap-2 items-center text-lg font-medium mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="fill-slate-500 size-4"
                ...
                <p className="text-base">{article.fullname}</p>
              </div>
