    ...
    <main className="w-full md:w-[980px] mx-auto text-slate-700 mb-10 md:mb-16 p-3">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
        {updates.map((update) => (
          <div
            key={update.id}
            className="ring-1 ring-slate-200 ring-inset p-4 bg-slate-100 rounded-md hover:bg-gradient-to-r from-red-100 via-red-50 to-red-200"
          >
            ...
            <Link to={`/news/${update.slug}`}>
              <h1 className="font-semibold text-lg underline underline-offset-4 mb-3">
                {update.title}
              </h1>
            </Link>
